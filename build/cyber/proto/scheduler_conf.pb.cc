...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_choreography_5fconf_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_ChoreographyConf;
}  // namespace protobuf_choreography_5fconf_2eproto
namespace protobuf_classic_5fconf_2eproto {
extern PROTOBUF_INTERNAL_EXPORT_protobuf_classic_5fconf_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_ClassicConf;
}  // namespace protobuf_classic_5fconf_2eproto
namespace protobuf_scheduler_5fconf_2eproto {
extern PROTOBUF_INTERNAL_EXPORT_protobuf_scheduler_5fconf_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_InnerThread;
}  // namespace protobuf_scheduler_5fconf_2eproto
namespace apollo {
namespace cyber {
namespace proto {
...
::google::protobuf::internal::SCCInfo<3> scc_info_SchedulerConf =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 3, InitDefaultsSchedulerConf}, {
      &protobuf_scheduler_5fconf_2eproto::scc_info_InnerThread.base,
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "scheduler_conf.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "scheduler_conf.proto", &protobuf_RegisterTypes);
  ::protobuf_classic_5fconf_2eproto::AddDescriptors();
  ::protobuf_choreography_5fconf_2eproto::AddDescriptors();
}
...
const ::google::protobuf::Descriptor* InnerThread::descriptor() {
  ::protobuf_scheduler_5fconf_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_scheduler_5fconf_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const InnerThread& InnerThread::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_scheduler_5fconf_2eproto::scc_info_InnerThread.base);
...
::google::protobuf::Metadata InnerThread::GetMetadata() const {
  protobuf_scheduler_5fconf_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_scheduler_5fconf_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
const SchedulerConf& SchedulerConf::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_scheduler_5fconf_2eproto::scc_info_SchedulerConf.base);
  return *internal_default_instance();
}
